...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView campus_mail = findViewById(R.id.campus_mail);
        campus_mail.setMovementMethod(LinkMovementMethod.getInstance());
        campus_mail.setLinkTextColor(Color.BLACK);
    }
}