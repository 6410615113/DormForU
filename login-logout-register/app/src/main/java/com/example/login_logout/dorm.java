...
public class dorm extends AppCompatActivity {
    private ImageView accom, campus, city, haus, jpark, sky, tudio, uhouse, tooldorm, toolfav, tooluser ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tooldorm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(dorm.this, dorm.class);
                startActivity(intent);
            }
        });
        ...
        toolfav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(dorm.this, favorite.class);
                startActivity(intent);
            }
        });
        ...
        tooluser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(dorm.this, user.class);
                startActivity(intent);
            }
        });
